                ...
                <div class="card-header with-border">
                    ...
                    <div class="card-tools">
                        <div class="btn-group float-right mr-5">
                            <a href="{{ sc_route_admin('blog') }}" class="btn  btn-flat btn-default" title="List"><i
                  ...
                  <div class="form-group  row {{ $errors->has('title') ? ' text-red' : '' }}">
                      ...
                      <div class="form-group  row {{ $errors->has('keyword') ? ' text-red' : '' }}">
                        ...
                        <div class="form-group row kind  {{ $errors->has('category') ? ' text-red' : '' }}">
                            @php
                            $listCate =  App\Admin\Models\BlogCategory::where('status','!=', 2)->get();
                        ...
                        {{-- //select category --}}
                                ...
                                <div class="col-sm-8">
                                    <div class="input-group">
                                        ...
                                        <textarea type="textarea" id="description" name="description"
                                            value="{{ old() ? old('description') : $data['description'] ?? '' }}" class="form-control"
                                            placeholder="" />
                                             {{ old() ? old('content') : $data['description'] ?? '' }}
                                            </textarea>
                                    </div>
                            ...
                            <div class="form-group  row {{ $errors->has('url') ? ' text-red' : '' }}">
                                <label for="name" class="col-sm-2 col-form-label">Url customize</label>
                                <div class="col-sm-8">
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                            <div class="input-group-prepend">
                                        ...
                                        <input type="text" id="url" name="url"
                                            value="{{ old() ? old('url') : $data['url'] ?? '' }}" class="form-control"
                                            placeholder="" />
                                    </div>
                                    @if ($errors->has('url'))
                                        <span class="form-text">
                            ...
                            <div class="form-group  row {{ $errors->has('date') ? ' text-red' : '' }}">
                             ...
                             <div class="form-group  row {{ $errors->has('reading_time') ? ' text-red' : '' }}">
                                <label for="name" class="col-sm-2 col-form-label">Reading Time</label>
                                <div class="col-sm-8">
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                            <div class="input-group-prepend">
                                        ...
                                        <input type="text" id="reading_time" name="reading_time"
                                            value="{{ old() ? old('reading_time') : $data['reading_time'] ?? '' }}" class="form-control"
                                            placeholder="" />
                                    </div>
