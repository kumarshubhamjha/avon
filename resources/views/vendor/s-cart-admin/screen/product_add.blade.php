...
<div class="form-group kind  row">
    ...
    <div class="col-sm-8">
        <div class="input-group">
            <input type="text" id="feature_heading" name="feature_heading" value="{!! old('feature_heading') !!}"
                class="form-control input-sm" placeholder="Feature Heading" />
            <input type="text" id="feature_sub_heading" name="feature_sub_heading" value="{!! old('feature_sub_heading') !!}"
                class="form-control input-sm" placeholder="Feature Sub Heading" />
            <input type="text" id="feature" name="feature" value="{!! old('feature') !!}"
        ...
        <div id="preview_feature" class="img_holder">
            @if (old('feature'))
                <img src="{{ sc_file(old('feature')) }}">
            @endif
            
        </div>
    
        @if (!empty(old('sub_feature')))
        @foreach (old('sub_feature') as $key => $sub_feature)
        @if ($sub_feature)
        <div class="group-image group-feature">
            <div class="input-group">
                <input type="text" id="sub_feature_heading_{{ $key }}" name="sub_feature_heading[]" value="{!! old('sub_feature_heading') !!}"
                class="form-control input-sm" placeholder="Feature Heading" />
                <input type="text" id="sub_feature_sub_heading_{{ $key }}" name="sub_feature_sub_heading[]" value="{!! old('sub_feature_sub_heading') !!}"
                class="form-control input-sm" placeholder="Feature Sub Heading" />
                <input type="text" id="sub_feature_{{ $key }}"
                    name="sub_feature[]" value="{!! $sub_feature !!}"
...
<div class="form-group kind  row">
    ...
    <div class="col-sm-8">
        <div class="input-group">
            <input type="text" id="faq_question" name="faq_question" value="{!! old('faq_question') !!}"
                class="form-control" placeholder="FAQ Question" />
            <input type="text" id="faq_answer" name="faq_answer" value="{!! old('faq_answer') !!}"
        ...
        @if (!empty(old('sub_faq_question')))
        @foreach (old('sub_faq_question') as $key => $sub_faq_question)
        @if ($sub_faq_question)
        <div class="group-image group-faq">
            <div class="input-group">
                <input type="text" id="sub_faq_question_{{ $key }}" name="sub_faq_question[]" value="{!! old('sub_faq_question') !!}"
                class="form-control" placeholder="Feature Heading" />
                <input type="text" id="sub_faq_answer_{{ $key }}" name="sub_faq_answer[]" value="{!! old('sub_faq_answer') !!}"
