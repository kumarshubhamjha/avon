                            ...
                            <div class="col-sm-8">
                                <div class="input-group">
                                    ...
                                    <input type="text" id="pre_feature_heading" name="pre_feature_heading"
                                        value="{{ old('pre_feature_heading',$product->pre_feature_heading) }}"
                            ...
                            <div class="col-sm-8">
                                <div class="input-group">
                                    ...
                                    <input type="text" id="pre_feature_second_heading" name="pre_feature_second_heading"
                                        value="{{ old('pre_feature_second_heading',$product->pre_feature_second_heading) }}"
                            ...
                            <div class="col-sm-8">
                                <textarea id="pre_feature_content" class="editor"
                                    name="pre_feature_content">
                                        {!! old('pre_feature_content',$product->pre_feature_content) !!}
                                </textarea>
...
<div class="form-group row  {{ $errors->has('image') ? ' text-red' : '' }}">
    <label for="image" class="col-sm-2 col-form-label">Product Features</label>
    <div class="col-sm-8">
        <div class="input-group">
            <input type="text" id="feature_heading" name="feature_heading" value="{!! old('feature_heading', $product->feature_heading) !!}"
                class="form-control input-sm" placeholder="Feature Heading" />
            <input type="text" id="feature_sub_heading" name="feature_sub_heading" value="{!! old('feature_sub_heading', $product->feature_sub_heading) !!}"
                class="form-control input-sm" placeholder="Feature Sub Heading" />
            <input type="text" id="feature" name="feature" value="{!! old('feature', $product->feature) !!}"
                class="form-control input-sm image" placeholder="" readonly=""/>
            <div class="input-group-append">
                <span class="btn btn-primary lfm" data-input="feature" data-preview="preview_feature" data-type="product">
        ...
        <span class="form-text">
            <i class="fa fa-info-circle"></i> {{ $errors->first('feature') }}
        </span>
        @endif
        <div id="preview_feature" class="img_holder">
            @if (old('feature', $product->feature))
                <img src="{{ sc_file(old('feature', $product->feature)) }}">
            @endif
            
        </div>
        @php
        $listsubFeatures = $product->features->all();
        //echo '<pre>';print_r($listsubFeatures);echo '</pre>';die;
        @endphp
        @if (!empty($listsubFeatures))
        @foreach ($listsubFeatures as $key => $sub_feature)
        @if ($sub_feature)
        <div class="group-image">
            <div class="input-group">
                <input type="text" id="sub_feature_heading_{{ $key }}" name="sub_feature_heading[]" value="{!! old('sub_feature_heading', $sub_feature->featureHeading) !!}"
                class="form-control input-sm" placeholder="Feature Heading" />
                <input type="text" id="sub_feature_sub_heading_{{ $key }}" name="sub_feature_sub_heading[]" value="{!! old('sub_feature_sub_heading', $sub_feature->featureSubHeading) !!}"
                class="form-control input-sm" placeholder="Feature Sub Heading" />
                <input type="text" id="sub_feature_{{ $key }}"
                    name="sub_feature[]" value="{!! old('sub_feature', $sub_feature->image) !!}"
                    class="form-control input-sm sub_image" placeholder="" readonly="" />
                    <span
                    class="input-group-btn"><span><a data-input="sub_feature_{{ $key }}"
                            data-preview="preview_sub_feature_{{ $key }}" data-type="product"
                            class="btn btn-flat btn-primary lfm"><i
                                class="fa fa-image"></i>
                            {{sc_language_render('product.admin.choose_image')}}</a></span><span
                        title="Remove" class="btn btn-flat btn-danger removeFeature"><i
                            class="fa fa-times"></i></span></span></div>
            <div id="preview_sub_feature_{{ $key }}" class="img_holder"><img
                    src="{{ sc_file($sub_feature->image) }}"></div>
        </div>

        @endif
        @endforeach
        @endif
        <button type="button" id="add_sub_feature" class="btn btn-flat btn-success">
            <i class="fa fa-plus" aria-hidden="true"></i>
            Add More Features
        </button>
...
<div class="form-group row">
    <label for="image" class="col-sm-2 col-form-label">Product Faq</label>
    <div class="col-sm-8">
        <div class="input-group">
            <input type="text" id="faq_question" name="faq_question" value="{!! old('faq_question', $product->faq_question) !!}"
                class="form-control input-sm" placeholder="FAQ Question" />
            <input type="text" id="faq_answer" name="faq_answer" value="{!! old('faq_answer', $product->faq_answer) !!}"
                class="form-control input-sm" placeholder="FAQ Answer" />
        </div>
        ...
        @endif
        <div id="preview_feature" class="img_holder"></div>
        @php
        $listsubFaqs = $product->faqs->all();
        //echo '<pre>';print_r($listsubFeatures);echo '</pre>';die;
        @endphp
        @if (!empty($listsubFaqs))
        @foreach ($listsubFaqs as $key => $sub_faq)
        @if ($sub_faq)
        <div class="group-image">
            <div class="input-group">
                <input type="text" id="sub_faq_question_{{ $key }}" name="sub_faq_question[]" value="{!! old('sub_faq_question', $sub_faq->question) !!}"
                class="form-control input-sm" placeholder="FAQ Question" />
                <input type="text" id="sub_faq_answer_{{ $key }}" name="sub_faq_answer[]" value="{!! old('sub_faq_answer', $sub_faq->answer) !!}"
                class="form-control input-sm" placeholder="FAQ Answer" />
            </div>
...
// Add sub feature
var id_sub_feature = {{ old('sub_feature')?count(old('sub_feature')):0 }};
$('#add_sub_feature').click(function(event) {
    id_sub_feature +=1;
    $(this).before(
    '<div class="group-image group-feature">'
    +'<div class="input-group">'
    +'  <input type="text" id="sub_feature_heading_'+id_sub_feature+'" name="sub_feature_heading[]" value="" class="form-control input-sm" placeholder="Feature Heading"  />'
    +'  <input type="text" id="sub_feature_sub_heading_'+id_sub_feature+'" name="sub_feature_sub_heading[]" value="" class="form-control input-sm" placeholder="Feature Sub Heading"  />'
    +'  <input type="text" id="sub_feature_'+id_sub_feature+'" name="sub_feature[]" value="" class="form-control input-sm sub_image" placeholder="" readonly="" />'
    +'  <div class="input-group-append">'
    +'  <span data-input="sub_feature_'+id_sub_feature+'" data-preview="preview_sub_feature_'+id_sub_feature+'" data-type="product" class="btn btn-flat btn-primary lfm">'
    +'      <i class="fa fa-image"></i> {{sc_language_render('product.admin.choose_image')}}'
    +'  </span>'
    +' </div>'
    +'<span title="Remove" class="btn btn-flat btn-danger removeFeature"><i class="fa fa-times"></i></span>'
    +'</div>'
    +'<div id="preview_sub_feature_'+id_sub_feature+'" class="img_holder"></div>'
    +'</div>');
    ...
    $('.removeFeature').click(function(event) {
        $(this).closest('.group-image.group-feature').remove();
    });
//end sub feature
