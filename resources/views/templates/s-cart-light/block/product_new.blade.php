    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-9 tab-content" id="v-pills-tabContent">
                ...
                <div class="tab-pane fade" id="v-pills-{{$val->id}}" role="tabpanel"
                    aria-labelledby="v-pills-{{$val->id}}">
            ...
            <div class="col-lg-3 nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                @foreach ($category as $val)
                @foreach ($name as $title)
                    @if($val->id == $title->category_id)
                <a class="nav-link" id="v-pills-{{$val->id}}" data-toggle="pill" href="#v-pills-{{$val->id}}" role="tab"
                    aria-controls="v-pills-{{$val->id}}" aria-label="{{$title->title}}" aria-selected="true"><img src="img/icon/mtb.svg" alt="MTB">
