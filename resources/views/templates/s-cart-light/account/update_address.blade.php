    ...
    <div class="form-wrapper">
        ...
        <div class="form-group row {{ $errors->has('first_name') ? ' has-error' : '' }}">
            <label for="first_name"
                class="col-md-3">{{ sc_language_render('customer.first_name') }}</label>
        ...
        <div class="form-group row {{ $errors->has('last_name') ? ' has-error' : '' }}">
            <label for="last_name"
                class="col-md-3">{{ sc_language_render('customer.last_name') }}</label>
        ...
        <div class="form-group row {{ $errors->has('first_name') ? ' has-error' : '' }}">
            <label for="first_name"
                class="col-md-3">{{ sc_language_render('customer.name') }}</label>
        ...
        <div class="form-group row">
            <label for="default"
                class="col-md-3t">{{ sc_language_render('customer.address_set_default') }}</label>
            <div class="col-md-6">
